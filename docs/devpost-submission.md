...
| Six camera-pouch and claimant fixture images in `public/assets/` | Synthetic images generated specifically for Found Roll; no real claimant or personal data | Project fixture use; generation method disclosed. Preserve the frozen SHA-256 manifest below. |
...
| `public/assets/pouch-serial-detail.jpg` | `7189901bb01d2130f18fc96f17a86529254a4a5e789c043a225993a6ee191a6d` |
