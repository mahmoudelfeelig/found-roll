...
| FR-008 | Run the canonical candidate packet through the deterministic fixture analyst | Typed local analyst proposal | Canonical candidate selected, claim acceptance remains false, question is non-leading, restricted fields excluded, twelve-call cap and 2,048-output-token cap preserved |
