...
try {
    ...
    Assert-JsonInvariant `
        ...
        -Check { param($x) $x.fixture_count -eq 15 -and $x.passed_count -eq 15 -and $x.failed_count -eq 0 -and $x.status -eq 'LOCAL_PASS_CANONICAL_INCOMPLETE' } `
